...
export default function HomeScreen() {
  ...
  const trendingItems: TrendingProduct[] = [
    { id: 't1', name: 'Rhapsody Bomber Jacket', price: 90, rating: 4.8, image: require('../../assets/image/image 2.png') },
    { id: 't2', name: 'Rhapsody Premium Bomb...', price: 90, rating: 4.8, image: require('../../assets/image/image 1.png') },
    { id: 't3', name: 'Rhapsody Bomber Jacket', price: 90, rating: 4.8, image: require('../../assets/image/image 2.png') },
    { id: 't4', name: 'Rhapsody Premium Bomb...', price: 90, rating: 4.8, image: require('../../assets/image/image 1.png') },
  ];
